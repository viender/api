...
namespace Viender\Sitemap\Http\Controllers\Api;

use Response;
use League\Fractal\Manager;
use Viender\Sitemap\Http\Controllers\Controller;
use League\Fractal\Resource\Collection;
use League\Fractal\Pagination\IlluminatePaginatorAdapter;
use Viender\Sitemap\Transformers\Serializer\ArraySerializer;
