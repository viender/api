...
namespace Viender\Campaign\Http\Controllers\Api;

use Response;
use League\Fractal\Manager;
use Viender\Campaign\Http\Controllers\Controller;
use League\Fractal\Resource\Collection;
use League\Fractal\Pagination\IlluminatePaginatorAdapter;
use Viender\Campaign\Transformers\Serializer\ArraySerializer;
