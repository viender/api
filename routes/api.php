...
Route::group(['namespace' => 'Api\Version1'], function() {
    ...
    Route::resource('streets', 'StreetsController', ['except' => ['create', 'edit']]);
    ...
    Route::resource('cities.streets', 'CityStreetsController', ['except' => ['create', 'edit']]);
    Route::resource('streets.addresses', 'StreetAddressesController', ['except' => ['create', 'edit']]);
});