...
namespace App\Ideapool\Notifications;
...
class UpvotableUpvotedNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        if($this->upvote->upvotable_type == 'App\Ideapool\Question') {

            $url = config('app.viender_web_url') . '/questions/' . $upvotable->slug;

        }elseif($this->upvote->upvotable_type == 'App\Ideapool\Answer') {

            $url = config('app.viender_web_url') . '/answers/' . $upvotable->id;

        }elseif($this->upvote->upvotable_type == 'App\Ideapool\Comment') {
