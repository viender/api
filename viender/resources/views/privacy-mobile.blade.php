...
<div class="container">
    <div class="row">
        <h1 class="center" style="font-size: 32px; padding: 32px 0;">Privacy Policy</h1>
        <p>Last updated: Juni 01, 2017</p>
        <p>We recognize that your privacy is very important and take it seriously. This Privacy Policy describes Viender’s policies and procedures on the collection, use, disclosure, and sharing of your information when you use the Viender Service, via the Viender website, Viender content embedded on another site (such as a Viender “Follow” button), your mobile phone, or through one of Viender’s applications for mobile devices (e.g., the Viender iPhone application). We will not use or share your information with anyone except as described in this Privacy Policy. This Privacy Policy does not apply to information we collect by other means (including offline) or from other sources. Capitalized terms that are not defined in this Privacy Policy have the meaning given them in our Terms of Service.</p>

        <p><b>Information Collection and Use</b></p>

        <p>Viender uses information we collect to analyze how the Service is used, diagnose service or technical problems, maintain security, personalize content, remember information to help you efficiently access your account, monitor aggregate metrics such as total number of visitors, traffic, and demographic patterns, and track User Content and users as necessary to comply with the Digital Millennium Copyright Act and other applicable laws.</p>

        <p><b>User-Provided Information:</b></p>

        <p>You provide us information about yourself, such as your name, e-mail address and interests, if you register for a member account with the Service. Your name and other information you choose to add to your profile will be available for public viewing on the Service. You may provide us with your mobile phone number if you choose to submit questions and receive answers via text message. We may use your email address to send you Service-related notices (including any notices required by law, in lieu of communication by postal mail). You can control receipt of certain Service-related messages on your Settings page. We may also use your contact information to send you marketing email messages. If you do not want to receive such messages, you may opt out by following the instructions in the message. If you correspond with us by email, we may retain the content of your email messages, your email address and our responses.</p>

        <p>If you use your Google, Facebook, Twitter, or other social networking site (“SNS”) account information to sign in to Viender, we will collect and store your SNS user ID. If you connect your Viender account with your SNS account (such as to enable posting from Viender), we ask for your permission to collect certain information from your SNS account (such as information from your SNS profile).</p>
        ...
        <p>If you choose to use our invitation service to invite a friend to the Service, we will ask you for that person’s email address and automatically send an email invitation. You may also use our contact importer tool to help you upload your friends’ email addresses so you can find friends who are already on Viender or invite friends to the Service. Viender stores this information to send invitations, to register your friend if your invitation is accepted, to track the success of our invitation service, and to identify your friends on Viender. By providing your friends’ email addresses to Viender, you warrant that you have their consent to do so and for Viender to use this information as described above.</p>
        ...
        <p>Viender discloses a subset of this automatically collected information publicly. Specifically, you consent to Viender’s disclosure of information related to the ways in which you interact with the Service, such as: landing pages, pages viewed and the order of those pages (including questions and answers viewed), the date and time you used the Service, and other similar information on the Service to other Viender users, along with your name and profile picture. If you do not wish to have this information disclosed to the public, you may opt out of this feature by visiting settings.</p>
        ...
        <p>Authentication and security cookies. We use these cookies to enable you to remain logged into Viender, and verify that it is you as you use Viender. This helps keep your account safe and secure from unauthorized use, and helps combat spam and other abuse which violates our policies.</p>

        <p>Analytics and research cookies. We use these cookies to better understand how people use Viender. For example, how often particular features are used, or which content leads towards user activity.</p>

        <p>Product features and setting cookies. We use these cookies to enable the functionality of some features within the Viender product, in particular to personalize the experience towards you. We also use these cookies to store certain of your preferences and settings.</p>
        ...
        <p><b>Third Party Analytics and Advertising</b></p>

        <p>Viender may allow third parties to help us collect and analyze information about your use of the service, generate aggregate site usage statistics and provide content sharing services to support the Service. These third parties may also use cookies and similar technologies to collect similar information about your use of the Service. Viender does not control the third parties’ use of such technologies and their use is governed by those parties’ privacy policies.</p>

        <p>Viender may also allow third-party ad servers or ad networks to serve advertisements on the Service and on third-party services. These third-party ad servers or ad networks use technology to send, directly to your browser, the advertisements and links that appear on Viender. They automatically receive your IP address when this happens. They may also use other technologies (such as cookies, JavaScript, or web beacons) to measure the effectiveness of their advertisements and to personalize the advertising content. Viender does not provide any information that can identify you personally to these third-party ad servers or ad networks without your consent. However, please note that if an advertiser asks Viender to show an advertisement to a certain audience and you respond to that advertisement, the advertiser or ad server may conclude that you fit the description of the audience they are trying to reach.</p>

        <p>Viender itself does not respond to “do not track” signals, and we do not control whether third parties do. For more information about third-party ad networks that use cookies and the other technologies discussed above, and to opt-out of their tailoring of ads on third-party sites based on this information, see <a href="http://optout.networkadvertising.org">http://optout.networkadvertising.org</a> and For Consumers | <a href="http://www.aboutads.info/consumers">http://www.aboutads.info/consumers</a></p>

        <p><b>How We Share Your Information</b></p>

        <p>Viender may share your information with third party service providers for the purpose of providing the Service to you, such as payment processors, email service providers, and providers of technical infrastructure (such as servers or databases co-located with hosting providers), engineering, or other support.</p>

        <p>We may also share your information with third parties offering combined services with Viender. For example, we may share your information with third-party partners that display Viender questions and answers through their services so that such partners can tailor content and advertising to you. If we do this, such third parties’ use of your information will be bound by this Privacy Policy.</p>
        ...
        <p>We may disclose your information if we are required to do so by law, or if we believe in good faith that it is reasonably necessary to (i) respond to claims asserted against us or to comply with legal process (for example, subpoenas or warrants), (ii) enforce or administer our agreements with users, such as the Terms of Service; (iii) for fraud prevention, risk assessment, investigation, customer support, product development and de-bugging purposes, or (iv) protect the rights, property or safety of Viender, its users, or members of the public.</p>

        <p>By using the Service you consent to the transfer of your information to the United States and/or to other countries for storage, processing and use by Viender in accordance with our Privacy Policy.</p>
        ...
        <p>Viender uses a variety of physical, managerial, and technical safeguards to preserve the integrity and security of your information, based on the sensitivity of the information. We cannot, however, ensure or warrant the security of any information you transmit to Viender or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by breach of any of our physical, technical, or managerial safeguards.</p>

        <p><b>Your Choices About Your Information</b></p>

        <p>You may, of course, decline to submit information through the Service, in which case Viender may not be able to provide certain services to you. You may update or correct your account information and email preferences at any time by logging in to your account. You may also delete your account if you chose to.</p>

        <p><b>Children’s Privacy</b></p>

        <p>Protecting the privacy of young children is especially important. Viender does not knowingly collect or solicit personal information from anyone under the age of 13 (or under the age of 14 for anyone living in Spain or South Korea) or knowingly allow such persons to register with the Service. If we become aware that we have collected personal information from a child under the relevant age without parental consent, we take steps to remove that information.</p>
        ...
        <p>If you have any questions about our practices or this Privacy Policy, please contact us at <a href="mailto:privacy@viender.com" target="_top">privacy@viender.com</a></p>
    </div>
</div>
@endsection
