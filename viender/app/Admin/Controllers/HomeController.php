    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) {
                $row->column(3, new InfoBox('Total Users', 'users', 'aqua', '/admin/auth/users', User::all()->count()));
                $row->column(3, new InfoBox('Total Questions', 'question-circle', 'green', '/admin/socialite/questions', Question::all()->count()));
                $row->column(3, new InfoBox('Total Answers', 'commenting', 'yellow', '/admin/socialite/answers', Answer::all()->count()));
                $row->column(3, new InfoBox('Total Comments', 'comment-o', 'red', '#', Comment::all()->count()));
            });
